...
const riddleContainer=document.querySelector('.riddle-content');
   // to clear html us innerhtml method and pass empty tag
...
const newImg=document.createElement('img');
newImg.setAttribute('src',randomMemeurl);
   //the user story is that if there is an existing meme hjust replace there only so we need to if sthere is a meme present or not
   clearAll();
...
function revealAnswers(){
   ...
   answer.hidden=false;
    ...
    alert('There is no riddle to reveal the answer');
}
}
